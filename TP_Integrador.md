...
![Estructura de bloques encadenados mediante hashes](img/tpi_blockchain_chain.jpg)
...
![Estructura de bloques con sub-bloques de transacciones](img/tpi_block_structure.jpg)
...
![GPUs NVIDIA y el ecosistema de computación paralela](img/tpi_nvidia_gpus.png)
...
![Pilar 1 - Pipeline de Minería CUDA](img/tpi_pilar1.png)
...
![Pilar 2 - Arquitectura Distribuida](img/tpi_pilar2.png)
...
![Pilar 3 - Despliegue en Kubernetes](img/tpi_pilar3.png)
